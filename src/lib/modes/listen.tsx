...
function ListenPrompt({ word }: PromptProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <span className="text-sm text-slate-400">🔊 Listen, then type it below</span>
    </div>
  );
}

function ListenControls({ word }: ControlsProps) {
...
export const listenMode: ModeDefinition = {
  id: "listen",
  name: "Listen & Type",
  description: "See the word and hear it spoken. Type it to build spelling and pronunciation together.",
  href: "/listen",
  emoji: "🔊",
  Prompt: ListenPrompt,
